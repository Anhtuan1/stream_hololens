...
public class ClickStream1 : MonoBehaviour, IInputClickHandler
{
    public void OnInputClicked(InputClickedEventData eventData)
    {
        Debug.Log("CLICK STREAM 1");
        ...
        if (MyObject_stream1 != null)
        {
            ...
            go.GetComponent<SocketReceiveStream>().stream_name = "stream1";
        }
        ...
        if (MyObject_stream2 != null)
        {
            ...
            go2.GetComponent<SocketSendStream>().stream_name = "stream2";
        }
