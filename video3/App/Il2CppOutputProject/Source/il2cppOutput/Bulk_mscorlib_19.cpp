...
extern const uint32_t Version_op_GreaterThan_m2354880383_MetadataUsageId;
...
extern "C"  bool Version_op_LessThan_m3745610070 (RuntimeObject * __this /* static, unused */, Version_t3456873960 * ___v10, Version_t3456873960 * ___v21, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
...
IL_008e:
	...
	}
	{
		...
		NullCheck(L_28);
		bool L_31 = VirtFuncInvoker1< bool, Type_t * >::Invoke(116 /* System.Boolean System.Type::IsSubclassOf(System.Type) */, L_28, L_30);
		if (L_31)
		{
			goto IL_00ba;
		}
...
IL_00db:
		{
			...
			NullCheck(L_42);
			Type_t * L_45 = VirtFuncInvoker2< Type_t *, String_t*, int32_t >::Invoke(60 /* System.Type System.Type::GetNestedType(System.String,System.Reflection.BindingFlags) */, L_42, L_44, ((int32_t)48));
			V_4 = L_45;
			Type_t * L_46 = V_4;
			IL2CPP_RUNTIME_CLASS_INIT(Type_t_il2cpp_TypeInfo_var);
...
IL_01b8:
	...
	}
	{
		...
		NullCheck(L_80);
		Type_t * L_82 = VirtFuncInvoker1< Type_t *, TypeU5BU5D_t3940880105* >::Invoke(103 /* System.Type System.Type::MakeGenericType(System.Type[]) */, L_80, L_81);
		V_1 = L_82;
	}
...
IL_007a:
	...
	}
	{
		...
		NullCheck(L_31);
		TypeU5BU5D_t3940880105* L_32 = VirtFuncInvoker0< TypeU5BU5D_t3940880105* >::Invoke(107 /* System.Type[] System.Type::GetGenericArguments() */, L_31);
...
IL_0073:
	{
		...
		NullCheck(L_11);
		Type_t * L_13 = VirtFuncInvoker1< Type_t *, TypeU5BU5D_t3940880105* >::Invoke(103 /* System.Type System.Type::MakeGenericType(System.Type[]) */, L_11, L_12);
...
IL_00ce:
	{
		...
		NullCheck(L_26);
		TypeU5BU5D_t3940880105* L_27 = VirtFuncInvoker0< TypeU5BU5D_t3940880105* >::Invoke(107 /* System.Type[] System.Type::GetGenericArguments() */, L_26);
...
extern "C"  bool Version_op_GreaterThan_m2354880383 (RuntimeObject * __this /* static, unused */, Version_t3456873960 * ___v10, Version_t3456873960 * ___v21, const RuntimeMethod* method)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (Version_op_GreaterThan_m2354880383_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(Version_t3456873960_il2cpp_TypeInfo_var);
		bool L_2 = Version_op_LessThan_m3745610070(NULL /*static, unused*/, L_0, L_1, /*hidden argument*/NULL);
		return L_2;
	}
}
